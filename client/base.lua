...
function Base:bindKey(key, mapper, onpress, onrelease)
  if not (key or mapper or onpress) then return end

  if onrelease then
    RegisterCommand("-c_regk:" .. key, onrelease, false)
    RegisterCommand("+c_regk:" .. key, onpress, false)
    RegisterKeyMapping("+c_regk:" .. key, 'Bind Key [' .. mapper .. '_' .. key .. ']', mapper, key)
  else
    RegisterCommand("c_regk:" .. key, onpress, false)
    RegisterKeyMapping("c_regk:" .. key, 'Bind Key [' .. mapper .. '_' .. key .. ']', mapper, key)
  end
